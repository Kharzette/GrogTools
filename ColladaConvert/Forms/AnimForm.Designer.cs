namespace ColladaConvert
{
	partial class AnimForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.EditRoughBound.Text = "Edit Bound";
			...
			this.ChoiceBox.TabStop = true;
			this.ChoiceBox.Text = "Box";
			this.ChoiceBox.UseVisualStyleBackColor = true;
			// 
			// ChoiceSphere
			// 
			...
			this.UnitsValve.Size = new System.Drawing.Size(52, 19);
